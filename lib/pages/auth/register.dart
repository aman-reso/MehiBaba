  ...
  registerButton(Size size) {
    return GestureDetector(
      onTap: () {
        ...
        if (mobileNumber.isNullOrEmpty || userName.isNullOrEmpty) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Please check Username or Mobile Number'),
            ),
          );
        } else {
          var result = LoginManager.createUser(
              mobileNumberController.text, userNameController.text);
